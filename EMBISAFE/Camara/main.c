...
//HAL_UART_Transmit(&huart3, (uint16_t*)pBuffer, strlen(pBuffer), 10000);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|PRUEBA_Pin|GPIO_PIN_14, GPIO_PIN_RESET);
