...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OUT_WUP_GPIO_Port, OUT_WUP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : OUT_WUP_Pin */
  GPIO_InitStruct.Pin = OUT_WUP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OUT_WUP_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : IN_0_Pin IN_2_Pin */
  GPIO_InitStruct.Pin = IN_0_Pin|IN_2_Pin;
